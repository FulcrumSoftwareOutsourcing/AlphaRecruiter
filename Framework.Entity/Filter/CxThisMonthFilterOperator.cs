...
{
  public class CxThisMonthFilterOperator : CxDateRangeFilterOperator
  {
    //-------------------------------------------------------------------------
    /// <summary>
    /// Constructor.
    ...
    public CxThisMonthFilterOperator(
    ...
    public override DateTime MinDate
    {
      get 
      { 
        return CxDate.GetDateWithLowestTime(CxDate.GetFirstMonthDay(DateTime.Today)); 
      }
    }
    //-------------------------------------------------------------------------
    /// <summary>
    ...
    public override DateTime MaxDate
    {
      get
      {
        return CxDate.GetDateWithHighestTime(CxDate.GetLastMonthDay(DateTime.Today), NxMaxMilliseconds.SqlServer);
      }
    }
    //-------------------------------------------------------------------------
  }
