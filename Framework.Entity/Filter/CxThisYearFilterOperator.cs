...
{
  public class CxThisYearFilterOperator : CxDateRangeFilterOperator
  {
    //-------------------------------------------------------------------------
    /// <summary>
    /// Constructor.
    ...
    public CxThisYearFilterOperator(
    ...
    public override DateTime MinDate
    {
      get 
      { 
        return CxDate.GetDateWithLowestTime(CxDate.GetFirstYearDay(DateTime.Today)); 
      }
    }
    //-------------------------------------------------------------------------
    /// <summary>
    ...
    public override DateTime MaxDate
    {
      get
      {
        return CxDate.GetDateWithHighestTime(CxDate.GetLastYearDay(DateTime.Today), NxMaxMilliseconds.SqlServer);
      }
    }
    //-------------------------------------------------------------------------
  }
