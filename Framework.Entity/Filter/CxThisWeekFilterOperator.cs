...
{
  public class CxThisWeekFilterOperator : CxDateRangeFilterOperator
  {
    //-------------------------------------------------------------------------
    /// <summary>
    /// Constructor.
    ...
    public CxThisWeekFilterOperator(
    ...
    public override DateTime MinDate
    {
      get
      {
        return CxDate.GetDateWithLowestTime(CxDate.GetFirstWeekDay(DateTime.Today));
      }
    }
    //-------------------------------------------------------------------------
    /// <summary>
    ...
    public override DateTime MaxDate
    {
      get
      {
        return CxDate.GetDateWithHighestTime(CxDate.GetLastWeekDay(DateTime.Today), NxMaxMilliseconds.SqlServer);
      }
    }
    //-------------------------------------------------------------------------
  }
