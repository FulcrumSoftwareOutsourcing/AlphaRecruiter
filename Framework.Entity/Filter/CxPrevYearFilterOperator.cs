...
{
  public class CxPrevYearFilterOperator : CxDateRangeFilterOperator
  {
    //-------------------------------------------------------------------------
    /// <summary>
    /// Constructor.
    ...
    public CxPrevYearFilterOperator(
    ...
    public override DateTime MinDate
    {
      get 
      { 
        return CxDate.GetDateWithLowestTime(CxDate.GetFirstPrevYearDay(DateTime.Today)); 
      }
    }
    //-------------------------------------------------------------------------
    /// <summary>
    ...
    public override DateTime MaxDate
    {
      get
      {
        return CxDate.GetDateWithHighestTime(CxDate.GetLastPrevYearDay(DateTime.Today), NxMaxMilliseconds.SqlServer);
      }
    }
    //-------------------------------------------------------------------------
  }
