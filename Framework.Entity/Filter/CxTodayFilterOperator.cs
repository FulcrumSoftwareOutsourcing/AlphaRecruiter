...
{
  public class CxTodayFilterOperator : CxDateRangeFilterOperator
  {
    //-------------------------------------------------------------------------
    /// <summary>
    /// Constructor.
    ...
    public override DateTime MinDate
    {
      get 
      {
        return CxDate.GetDateWithLowestTime(DateTime.Today);
      }
    }
    //-------------------------------------------------------------------------
    /// <summary>
    ...
    public override DateTime MaxDate
    {
      get
      {
        return CxDate.GetDateWithHighestTime(DateTime.Today, NxMaxMilliseconds.SqlServer);
      }
    }
    //-------------------------------------------------------------------------
  }
