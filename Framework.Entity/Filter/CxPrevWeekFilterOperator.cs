...
{
  public class CxPrevWeekFilterOperator : CxDateRangeFilterOperator
  {
    //-------------------------------------------------------------------------
    /// <summary>
    /// Constructor.
    ...
    public CxPrevWeekFilterOperator(
    ...
    public override DateTime MinDate
    {
      get 
      { 
        return CxDate.GetDateWithLowestTime(CxDate.GetFirstWeekDay(DateTime.Today.AddDays(-7))); 
      }
    }
    //-------------------------------------------------------------------------
    /// <summary>
    ...
    public override DateTime MaxDate
    {
      get
      {
        return CxDate.GetDateWithHighestTime(CxDate.GetLastWeekDay(DateTime.Today.AddDays(-7)), NxMaxMilliseconds.SqlServer);
      }
    }
    //-------------------------------------------------------------------------
  }
